...
import {Nav,NavbarToggler, Collapse, NavItem,Navbar, NavbarBrand, Jumbotron, Button, Modal, ModalHeader, ModalBody,
            ...
            <React.Fragment>
                <Navbar dark expand="md" className="header">
                    <div className="container">
                        ...
                        <NavbarBrand className="mr-auto"><img src="assets/images/logo.png" height="30" width="41" alt='Ristorante Con Fusion'/> </NavbarBrand>
